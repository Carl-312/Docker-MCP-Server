 ...
 * 处理设置连接请求
 */
export async function handleSetConnection(_client, args) {
    try {
 ...
 * 处理获取会话配置请求
 */
export async function handleGetSessionConfig(_client, _args) {
    const configManager = getSessionConfig();
    const config = configManager.getConfig();
    return {
        success: true,
 ...
 * 处理重置配置请求
 */
export async function handleResetConfig(_client, args) {
    try {
 ...
 * 会话配置工具处理器映射
 */
export const SESSION_CONFIG_HANDLERS = {
...
//# sourceMappingURL=session-config-tools.js.map